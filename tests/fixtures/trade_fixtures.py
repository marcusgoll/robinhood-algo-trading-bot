...
def sample_buy_trade() -> Dict[str, Any]:
    """Sample BUY trade fixture.

    Returns a complete TradeRecord-compatible dictionary representing
    a bull flag breakout entry in paper trading mode.

    Returns:
        dict: TradeRecord fields for a BUY trade
    """
    return {
...
def sample_sell_trade() -> Dict[str, Any]:
    ...
    Returns:
        dict: TradeRecord fields for a SELL trade (winner)
    """
...
def sample_loss_trade() -> Dict[str, Any]:
    ...
    Returns:
        dict: TradeRecord fields for a SELL trade (loser)
    """
...
def sample_breakeven_trade() -> Dict[str, Any]:
    ...
    Returns:
        dict: TradeRecord fields for a SELL trade (breakeven)
    """
...
def sample_live_trade() -> Dict[str, Any]:
    ...
    Returns:
        dict: TradeRecord fields for a LIVE BUY trade
    """
    return {
        # Core Trade Data (FR-002)
        "timestamp": datetime.now(timezone.utc).isoformat(),
...
def sample_trade_sequence() -> List[Dict[str, Any]]:
    ...
    Returns:
        list[dict]: List of TradeRecord-compatible dictionaries
    """
    return [
...
def sample_multi_symbol_sequence() -> List[Dict[str, Any]]:

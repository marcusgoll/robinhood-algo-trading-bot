#!/usr/bin/env python3
"""
Bot Health Monitor - Standalone Version (No Dependencies)
...
class BotMonitor:
    ...
    def __init__(self):
        ...
        self.enabled = os.getenv("TELEGRAM_ENABLED", "false").lower().strip() == "true"
        self.include_emojis = os.getenv("TELEGRAM_INCLUDE_EMOJIS", "true").lower().strip() == "true"
    ...
    def run_loop(self, interval=60):
        ...
        emoji = "📊" if self.include_emojis else ""
        self.send_notification(
            f"{emoji} *Bot Monitor Started*\\n\\n"
